<?php
	 ...
	 * @subpackage		Make
	 */
	class SOAPWebService extends MakeBase
	{
		/**
		 * Default namespace
		 * @var string
		...
		public function make($target, array $options = array())
		{
			...
			$baseClassName = '\\System\\Web\\Services\\SOAPWebServiceBase';
			$pageURI = $target;
			...
			$controllerTemplate = file_get_contents(\System\Base\ApplicationBase::getInstance()->config->root . "/system/make/templates/soapwebservice.tpl");
